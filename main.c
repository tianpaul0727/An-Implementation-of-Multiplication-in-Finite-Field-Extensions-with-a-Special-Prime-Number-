...
// below is testing clock cycles
  ...
  //testFp2Cycles();
  //testFp3Cycles(); when we want to test, we need to modify some parameter
  //testFp2OverFp2Cycles(); when we want to test, we need to modify some parameter
