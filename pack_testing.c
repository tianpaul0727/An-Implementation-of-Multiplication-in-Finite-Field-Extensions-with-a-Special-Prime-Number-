...
int correctnessNew(bigInteger* data,bigInteger* p){
    ...
    bigInteger res;
    bigIntInitial(&res); // result
	bigInteger two;
	bigIntInitial(&two);
	bigIntReadRadix(&two, "2",  10);
	bigIntReadRadix(&res, "1",  10); // the start of result is 1
	...
	bigIntSubtraction(p,&res,&p2);// p2 = p-1
...
bigIntCatch testCorrect_Method2(){
	...
	// test2  If the computing result exceeds the maximum storage range of signed int type, is there a possibility of data overflow
	  ...
	  bigIntVagueReduction(&testarr[2],&p);
	  ...
	  bigIntVagueReduction(&testarr[0],&p);
...
void testFp2Cycles(){
 ...
 for(int i =0; i< 10000; i++){
  ...
  bigInteger V0[2];
  bigIntIniCoefficient(V0,2);
  count +=Fp2mul(A0,A1,V0);
}
 count = count/k;
 printf("the clock cycles is : %lld \n", count);
...
for(int i =0; i< 1500; i++){
   ...
   long long a = Fp4_2input(M0,M1,N0,N1,results);
   long long aver = (a/k);
   count = count + aver;
}
...
for(int i =0; i< 2000; i++){
  ...
  long long a = Fp4_direct(M0,M1,result);
  count = count+ a;
}

count = (long long)(count/k);
...
for(int i =0; i< 2000; i++){
   ...
   long long a = Fp6_3over2input(A0,A1,A2,B0,B1,B2,res);
   long long aver = (a/k);
   count = count + aver;
}
printf("the clock cyles of Fp6(fp3 over fp2) : %lld \n", count);
...
for(int i =0; i< 3000; i++){
   ...
   long long a = Fp6_2over3input(A0,A1,B0,B1,res);
   long long aver = (a/k);
   count = count + aver;
}
printf("the clock cycles of F6(Fp2 over Fp3) is : %lld \n", count);
...
for(int i =0; i< 500; i++){
  ...
  bigIntIniCoefficient(res,12);
   ...
   long long a = Fp12_3overDirect4(m0,m1,m2,n0,n1,n2,res);
   long long aver = (a/k);
   count = count + aver;
}
...
for(int i =0; i< 100; i++){
 ...
 setRandCo(B21,2);
  ...
  bigIntIniCoefficient(res,12);
   ...
   long long a = Fp12_3over2over2(A00,A01,A10,A11,A20,A21,B00,B01,B10,B11,B20,B21,res);
   long long aver = (a/k);
   count = count + aver;
}
...
for(int i =0; i< 100; i++){
 ...
 setRandCo(B12,2);
  ...
  bigIntIniCoefficient(res,12);
   ...
   long long a = Fp12_2over3over2(A00,A01,A02,A10,A11,A12,B00,B01,B02,B10,B11,B12,res);
   long long aver = (a/k);
   count = count + aver;
}
...
for(int i =0; i< 100; i++){
 ...
 setRandCo(B11,3);
  ...
  bigIntIniCoefficient(res,12);
   ...
   long long a = Fp12_2over2over3(A00,A01,A10,A11,B00,B01,B10,B11,res);
   long long aver = (a/k);
   count = count + aver;
}
